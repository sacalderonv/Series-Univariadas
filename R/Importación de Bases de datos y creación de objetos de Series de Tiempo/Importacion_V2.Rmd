...
Es importante verificar que el paquete SLBDD esté disponible. Sin embargo, en el repositorio están los archivos con los datos que vamos ausar.


En ocasiones, tendremos que analizar dos o más series de tiempo de manera simultánea, esto es lo que se conoce como una **serie de tiempo multivariada**. La mayoría de los objetos que vimos anteriormente admiten series multivariadas, a continuación mostraremos algunos ejemplos con los objetos *xts*, *tsibble* y *timeSeries*, que no lo hemos explorado.
...
Llamamos a los datos de temperature  y los guardaremos en un objeto *xts*.
