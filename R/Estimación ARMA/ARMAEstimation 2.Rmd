...
acf(y)
acf(y,ci.type="ma",ci=0.99,ci.col="blue") ###q máximo 4
pacf(y) ###p máximo 1
...
Sunpots o manchas solares son regiones temporales mas ocuras que aparecn en la superficie del sol, las cuales están asociadas con campos magnéticos extremadamente intensos que inhiben parcialmente ek transporte de cslorndesdemel interior de sol hacia la superficie. Durante un máximo periodo solar aparecen muchas manchas.
...
Box.test(residuales, lag =18 , type = "Ljung-Box", fitdf = 4)#No puedo
Box.test(residuales^2, lag =18 , type = "Ljung-Box", fitdf = 4)#No puedoRechazar la hipótesis de no autocorrelación!
